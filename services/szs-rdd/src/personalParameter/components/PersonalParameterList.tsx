...
import PersonalParameterListFormSearch from './PersonalParameterListFormSearch'
import PersonalParameterListTable from './PersonalParameterListTable'
...
export default function PersonalParameterList({ data, pagination }: Props) {
  ...
  return (
    <>
      <PersonalParameterListFormSearch />
      <Spacing px={10} />
      <PersonalParameterListTable data={data ?? []} />
      <Spacing px={10} />
      <Pagination2
