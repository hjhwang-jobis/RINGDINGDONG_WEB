...
import AlimlistTemplateList from '~/alimlist/components/AlimlistTemplateList'
import Loader from '~/components/Loader'
import PageContainer from '~/components/PageContainer'
import { DEFAULT_PAGE_NO, DEFAULT_PAGE_SIZE, SortDirection } from '~/constants'
import { useGetAlimlistTemplatesListQuery } from '~/hooks/queries/alimlist/useGetAlimlistTemplatesListQuery'
import { apiUtils } from '~/utils'

export default function AlimlistTemplateListPage() {
  ...
  const {
    ...
    isLoading,
    error,
  } = useGetAlimlistTemplatesListQuery({
